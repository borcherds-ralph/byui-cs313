...
SELECT pg_catalog.setval('addresses_address_id_seq', 36, true);
...
SELECT pg_catalog.setval('doc_specialties_id_seq', 35, true);
...
SELECT pg_catalog.setval('doctors_doctor_id_seq', 40, true);
...
--
-- Name: menu_id_seq; Type: SEQUENCE SET; Schema: doclookup; Owner: byhflsokslaaes
--
...
--
-- Name: menu_menu_id_seq; Type: SEQUENCE SET; Schema: doclookup; Owner: byhflsokslaaes
--
...
SELECT pg_catalog.setval('specialties_specialty_id_seq', 110, true);
