...
function getAllrecords(){
    $db = get_db();
    $sql = "SELECT dc.doctor_id, dc.doctorFirstname, dc.doctorLastname, ad.docaddress1, ad.docaddress2, ad.docaddress3, ad.doccity, ad.docstate, ad.doczip FROM doclookup.doctors AS dc 
