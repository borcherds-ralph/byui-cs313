...
<h1>User Registration</h1>
            ...
            <form method="post" action="<?php echo $basepath ?>/?action=Register" id="registrationform">
                <fieldset>
                    <div>
                        <input class="requiredinvalid" id="first_name" name="first_name"
                    ...
                    <div>
                        <input class="requiredinvalid" id="last_name" name="last_name"
                    ...
                    <div>
                        <input class="requiredinvalid" id="username" name="username"
